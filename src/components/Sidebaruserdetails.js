...
import { faAngleDown, faScroll, faBriefcase, faCloud, faSliders, faHouse, faUserGroup, faXmark, faFan, faUsers, faSackDollar, faHandshake, faPiggyBank, faHandHoldingDollar, faUserXmark, faUserCheck, faLandmark, faCoins, faMobileScreen, faUserGear, faChartColumn, faClipboard, faArrowsSpin } from "@fortawesome/free-solid-svg-icons";
import { faBars } from "@fortawesome/free-solid-svg-icons";

const Sidebaruserdetails = ({handleLogout}) => {
        ...
        <div id="sidebarContent">
          ...
          <ul className="cont">
            ...
            <li className="nav-link">
              ...
              <FontAwesomeIcon icon={faArrowsSpin}/>
              <button  id="btt" className="btn btn-Default" onClick={Logout}>
                        Logout
                      </button>
              </li>
